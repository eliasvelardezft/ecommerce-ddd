...
class CreateProductCommand(BaseModel):
    ...
    image_url: ImageUrl | None = Field(None, description="Image URL for the product.")
    attributes: list[Attribute] | None = Field(None, description="List of product attributes.")
