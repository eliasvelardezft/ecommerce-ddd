...
class UpdateCategoryDetailsCommand(BaseModel):
    ...
    name: str | None = Field(
        None, min_length=1, max_length=255, description="New name for the category."
    )
    description: str | None = Field(
        None,
        description="New description for the category. Can be set to null explicitly by passing None.",
    )
