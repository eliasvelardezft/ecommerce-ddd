...
@pytest.fixture
async def sqlite_session(test_sqlite_engine) -> AsyncGenerator[AsyncSession]:
    """Create a clean SQLite session for each test."""
    async_session = sessionmaker(test_sqlite_engine, class_=AsyncSession, expire_on_commit=False)
...
def sample_category_data():
    ...
    return {"name": "Electronics", "description": "Electronic devices and accessories"}
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "mvp: marks tests as part of MVP flow")
